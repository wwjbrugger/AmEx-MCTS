...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--env-str', type=str,
                        help='The gym environment string')
    parser.add_argument("--seed", type=int)
    parser.add_argument('--num-sims', type=int,
                        dest='num_MCTS_sims', default=10,
    ...
    parser.add_argument('--risk-seeking', type=str2bool,
                        help='Acts risk seeking if true')
    ...
    parser.add_argument("--mcts-engine", type=str,
                        choices=['ClassicMCTS', 'EndgameMCTS'],
                        help="Which Engine should be used in MCTS?")
    parser.add_argument('--prior-source', type=str, default='uniform',
